  ...
  zones: [
    {
      ...
      sides: [
        ...
        { id: 'crosscut', name: 'The Crosscut', bonus: 'sluice', x: 60, y: 13 },
        { id: 'headings', name: 'The Headings', bonus: 'schooling', x: 84, y: 12 },
        { id: 'stope', name: 'The Old Stope', bonus: 'trove', x: 50, y: 22 },
        { id: 'gallery', name: 'The Upper Gallery', bonus: 'richseam', x: 74, y: 28 },
        { id: 'winze', name: 'The Winze', bonus: 'coinfall', x: 48, y: 31 },
        { id: 'stull', name: 'The Stull', bonus: 'richseam', x: 15, y: 41 },
        { id: 'rise', name: 'The Rise', bonus: 'trove', x: 70, y: 40 },
        { id: 'shelf', name: 'The Lit Shelf', bonus: 'sluice', x: 74, y: 51 },
        { id: 'level', name: 'The Long Level', bonus: 'schooling', x: 20, y: 53 },
        { id: 'adit', name: 'The Far Adit', bonus: 'coinfall', x: 84, y: 62 },
        { id: 'sump', name: 'The Sump', bonus: 'swarm', x: 33, y: 67 },
        { id: 'deadend', name: 'The Dead End', bonus: 'trove', x: 45, y: 79 },
        { id: 'bottom', name: 'The Bottom Level', bonus: 'swarm', x: 28, y: 88 },
      ],
      links: [
        { from: 'd2', to: 'spoil', path: [[21,28],[27,28],[35,13],[40,12]] },
        { from: 'spoil', to: 'crosscut' },
        { from: 'crosscut', to: 'headings', path: [[60,13],[68,13],[70,11],[75,20],[80,13],[84,12]] },
        { from: 'spoil', to: 'stope' },
        { from: 'stope', to: 'winze', path: [[50,22],[49,22],[48,31]] },
        { from: 'winze', to: 'd4', path: [[48,31],[42,31],[38,38]] },
        { from: 'd5', to: 'winze', path: [[44,47],[40,42],[40,36],[43,31],[48,31]] },
        { from: 'crosscut', to: 'gallery', path: [[60,13],[65,13],[65,26],[67,28],[74,28]] },
        { from: 'headings', to: 'gallery', path: [[84,12],[80,13],[75,19],[74,28]] },
        { from: 'gallery', to: 'rise', path: [[74,28],[75,37],[70,40]] },
        { from: 'rise', to: 'd6', path: [[70,40],[60,40],[54,51],[52,51]] },
        { from: 'rise', to: 'shelf' },
        { from: 'd3', to: 'stull', path: [[30,31],[25,28],[15,41]] },
        { from: 'stull', to: 'level' },
        { from: 'level', to: 'sump' },
        { from: 'sump', to: 'bottom', path: [[33,67],[26,68],[23,75],[23,86],[28,88]] },
        { from: 'bottom', to: 'deadend', path: [[28,88],[40,88],[42,82],[45,79]] },
        { from: 'deadend', to: 'd8', path: [[45,79],[50,79],[53,81],[59,69],[61,67],[65,68]] },
        { from: 'sump', to: 'd7', path: [[33,67],[48,67],[52,55],[58,60]] },
        { from: 'd6', to: 'shelf' },
        { from: 'shelf', to: 'adit', path: [[74,51],[80,53],[80,62],[84,62]] },
        { from: 'adit', to: 'd10', path: [[84,62],[75,77],[79,81]] },
      ],
