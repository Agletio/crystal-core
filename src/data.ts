  ...
  zones: [
    {
      ...
      sides: [
        ...
        { id: 'drift', name: 'The Drift', bonus: 'coinfall', x: 63, y: 28 },
        ...
        { id: 'adit', name: 'The Adit', bonus: 'richseam', x: 82, y: 62 },
        { id: 'faradit', name: 'The Far Adit', bonus: 'schooling', x: 91, y: 61 },
        { id: 'oldworks', name: 'The Old Workings', bonus: 'swarm', x: 15, y: 40 },
        { id: 'level', name: 'The Long Level', bonus: 'coinfall', x: 19, y: 54 },
        { id: 'crosslevel', name: 'The Cross Level', bonus: 'sluice', x: 28, y: 53 },
      ...
      links: [
        ...
        { from: 'rise', to: 'chimney', path: [[78,12],[87,12]] },
        { from: 'crosscut', to: 'stope', path: [[44,21],[44,31]] },
        { from: 'stope', to: 'winze', path: [[44,31],[54,31]] },
        { from: 'adit', to: 'faradit', path: [[82,62],[91,61]] },
        { from: 'level', to: 'crosslevel', path: [[19,54],[28,53]] },
        { from: 'deadend', to: 'lastlevel', path: [[44,78],[43,88]] },
        { from: 'gullet', to: 'deadend', path: [[43,66],[44,78]] },
        { from: 'drift', to: 'gallery', path: [[63,28],[72,28],[72,26],[74,26]] },
        { from: 'deeplevel', to: 'footwall', path: [[21,74],[21,87]] },
        { from: 'd4', to: 'stope', path: [[37,38],[40,38],[40,33],[44,31]] },
        { from: 'chimney', to: 'bench', path: [[87,12],[87,26]] },
        { from: 'gallery', to: 'bench', path: [[74,26],[87,26]] },
        { from: 'bottom', to: 'footwall', path: [[10,87],[10,89],[21,89],[21,87]] },
        { from: 'crosslevel', to: 'sump', path: [[28,53],[30,66]] },
        { from: 'sump', to: 'gullet', path: [[30,66],[43,66]] },
        { from: 'sump', to: 'deeplevel', path: [[30,66],[26,66],[25,72],[21,74]] },
        { from: 'spoil', to: 'crosscut', path: [[40,12],[40,22],[44,21]] },
        { from: 'crosscut', to: 'breast', path: [[44,21],[59,21]] },
        { from: 'gallery', to: 'rise', path: [[74,26],[78,12]] },
        { from: 'heading', to: 'drift', path: [[62,11],[63,28]] },
        { from: 'd2', to: 'oldworks', path: [[21,28],[22,34],[20,34],[18,40],[15,40]] },
        { from: 'bench', to: 'plat', path: [[87,26],[83,27],[81,39],[79,39]] },
        { from: 'd9', to: 'adit', path: [[73,73],[78,74],[82,62]] },
        { from: 'plat', to: 'shaftfoot', path: [[79,39],[78,52],[71,52],[71,48]] },
        { from: 'd4', to: 'crosslevel', path: [[37,38],[34,38],[34,45],[31,48],[31,53],[28,53]] },
        { from: 'oldworks', to: 'level', path: [[15,40],[12,41],[12,54],[19,54]] },
