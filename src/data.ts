  ...
  zones: [
    {
      ...
      sides: [
        ...
        { id: 'crosscut', name: 'The Crosscut', bonus: 'sluice', x: 44, y: 21 },
        { id: 'breast', name: 'The Breast', bonus: 'trove', x: 53, y: 21 },
        { id: 'stope', name: 'The Old Stope', bonus: 'richseam', x: 44, y: 30 },
        { id: 'winze', name: 'The Winze', bonus: 'schooling', x: 54, y: 30 },
        { id: 'heading', name: 'The Heading', bonus: 'swarm', x: 62, y: 12 },
        { id: 'drift', name: 'The Drift', bonus: 'coinfall', x: 63, y: 26 },
        { id: 'gallery', name: 'The Upper Gallery', bonus: 'sluice', x: 74, y: 26 },
        { id: 'rise', name: 'The Rise', bonus: 'trove', x: 78, y: 12 },
        { id: 'chimney', name: 'The Chimney', bonus: 'richseam', x: 87, y: 12 },
        { id: 'bench', name: 'The Bench', bonus: 'schooling', x: 87, y: 26 },
        { id: 'stull', name: 'The Stull', bonus: 'swarm', x: 72, y: 38 },
        { id: 'plat', name: 'The Plat', bonus: 'coinfall', x: 79, y: 38 },
        { id: 'slope', name: 'The Slope', bonus: 'sluice', x: 62, y: 39 },
        { id: 'shaftfoot', name: 'The Shaft Foot', bonus: 'trove', x: 71, y: 48 },
        { id: 'sollar', name: 'The Sollar', bonus: 'richseam', x: 79, y: 48 },
        { id: 'adit', name: 'The Adit', bonus: 'richseam', x: 82, y: 61 },
        { id: 'faradit', name: 'The Far Adit', bonus: 'schooling', x: 91, y: 61 },
        { id: 'oldworks', name: 'The Old Workings', bonus: 'swarm', x: 12, y: 40 },
        { id: 'level', name: 'The Long Level', bonus: 'coinfall', x: 12, y: 52 },
        { id: 'crosslevel', name: 'The Cross Level', bonus: 'sluice', x: 28, y: 52 },
        { id: 'sump', name: 'The Sump', bonus: 'trove', x: 28, y: 66 },
      ...
      links: [
        ...
        { from: 'level', to: 'crosslevel' },
        { from: 'crosslevel', to: 'sump' },
        { from: 'd4', to: 'crosslevel' },
        { from: 'sump', to: 'gullet' },
        { from: 'sump', to: 'deeplevel', path: [[28,66],[25,72],[21,74]] },
        { from: 'gullet', to: 'deadend' },
        { from: 'd6', to: 'gullet', path: [[51,51],[51,56],[44,66]] },
        { from: 'd2', to: 'oldworks', path: [[21,28],[22,33],[17,41],[12,40]] },
        { from: 'deadend', to: 'lastlevel' },
        { from: 'lastlevel', to: 'footwall' },
        { from: 'deeplevel', to: 'footwall' },
        { from: 'footwall', to: 'bottom' },
        { from: 'd2', to: 'spoil', path: [[21,28],[28,25],[36,12],[40,12]] },
        { from: 'd4', to: 'stope', path: [[37,38],[41,32],[44,30]] },
        { from: 'stope', to: 'crosscut' },
        { from: 'stope', to: 'winze' },
        { from: 'crosscut', to: 'breast' },
        { from: 'breast', to: 'heading', path: [[53,21],[53,15],[56,12],[62,12]] },
        { from: 'heading', to: 'drift' },
        { from: 'drift', to: 'gallery' },
        { from: 'gallery', to: 'rise' },
        { from: 'gallery', to: 'bench' },
        { from: 'gallery', to: 'stull' },
        { from: 'rise', to: 'chimney' },
        { from: 'chimney', to: 'bench' },
        { from: 'stull', to: 'plat' },
        { from: 'stull', to: 'slope' },
        { from: 'slope', to: 'd6', path: [[62,39],[59,40],[55,49],[51,51]] },
        { from: 'plat', to: 'sollar' },
        { from: 'sollar', to: 'shaftfoot' },
        { from: 'sollar', to: 'adit' },
        { from: 'adit', to: 'faradit' },
        { from: 'adit', to: 'd9', path: [[82,62],[76,74],[72,72]] },
        { from: 'd7', to: 'deadend', path: [[58,59],[60,69],[56,74],[53,78],[44,78]] },
      ],
      rungs: 12, arena: 'answering_hall', world: 'fissure', tier: 1,
    },
    {
      id: 'prismatic', name: 'The Prism', art: 'climb_act2',
      path: [[6,11],[12,11],[23,20],[28,29],[31,33],[39,34],[45,45],[49,52],[57,52],[68,71],[77,72],[86,87],[94,92]],
      sides: [
        { id: 'coldgallery', name: 'The Cold Gallery', bonus: 'coinfall', x: 11, y: 46 },
        { id: 'facet', name: 'The Facet', bonus: 'sluice', x: 26, y: 54 },
        { id: 'cutface', name: 'The Cut Face', bonus: 'trove', x: 34, y: 54 },
        { id: 'litshelf', name: 'The Lit Shelf', bonus: 'richseam', x: 46, y: 13 },
        { id: 'glasshouse', name: 'The Glasshouse', bonus: 'schooling', x: 57, y: 13 },
        { id: 'brightcut', name: 'The Bright Cut', bonus: 'swarm', x: 69, y: 14 },
        { id: 'spire', name: 'The Spire', bonus: 'coinfall', x: 89, y: 15 },
        { id: 'growth', name: 'The Growth', bonus: 'sluice', x: 68, y: 31 },
        { id: 'clerestory', name: 'The Clerestory', bonus: 'trove', x: 89, y: 26 },
        { id: 'lantern', name: 'The Lantern', bonus: 'richseam', x: 73, y: 46 },
        ...
        { id: 'heart', name: 'The Heart of the Prism', bonus: 'swarm', x: 27, y: 90 },
      ],
      links: [
        { from: 'coldgallery', to: 'd2', path: [[11,46],[11,21],[15,14]] },
        { from: 'coldgallery', to: 'facet', path: [[11,46],[19,46],[24,54],[26,54]] },
        { from: 'facet', to: 'cutface' },
        { from: 'd4', to: 'litshelf', path: [[28,29],[37,24],[43,14],[46,13]] },
        { from: 'litshelf', to: 'glasshouse' },
        { from: 'glasshouse', to: 'brightcut' },
        { from: 'brightcut', to: 'growth' },
        { from: 'brightcut', to: 'spire' },
        { from: 'spire', to: 'clerestory' },
        { from: 'clerestory', to: 'lantern', path: [[89,26],[78,25],[74,34],[73,46]] },
        { from: 'prismseam', to: 'clerestory' },
        { from: 'prismseam', to: 'splinter' },
        { from: 'splinter', to: 'threshold' },
        { from: 'threshold', to: 'farthreshold', portal: [[96,64],[36,73]] },
        { from: 'farthreshold', to: 'silence', path: [[33,73],[27,74],[17,67],[10,67]] },
        { from: 'silence', to: 'deepfacet', portal: [[7,67],[6,90]] },
        { from: 'deepfacet', to: 'heart' },
        { from: 'd8', to: 'vault', path: [[55,52],[51,56],[51,79],[49,91]] },
        { from: 'd11', to: 'sink', path: [[74,72],[70,74],[70,92]] },
        { from: 'd7', to: 'growth', path: [[47,48],[54,42],[61,31],[68,31]] },
      ],
      rungs: 14, arena: 'refraction_hall', world: 'prismatic', tier: 2,
    },
    {
      id: 'demonic', name: 'The Rot', art: 'climb_act3',
      path: [[10, 9], [17, 18], [28, 33], [40, 34], [47, 45], [52, 54], [61, 56], [75, 78], [78, 79], [90, 93]],
      blurb: 'Older than anybody who dug toward it. Nothing down here was worked.',
      portalArt: 'portal_rot',
      sides: [
        { id: 'blister', name: 'The Blister', bonus: 'coinfall', x: 62, y: 15 },
        { id: 'weeping', name: 'The Weeping Wall', bonus: 'sluice', x: 15, y: 31 },
        { id: 'crop', name: 'The Crop', bonus: 'trove', x: 90, y: 64 },
        { id: 'lung', name: 'The Lung', bonus: 'richseam', x: 82, y: 64 },
        { id: 'ribs', name: 'The Ribs', bonus: 'schooling', x: 83, y: 39 },
        { id: 'gorge', name: 'The Gorge', bonus: 'coinfall', x: 70, y: 39 },
        { id: 'craw', name: 'The Craw', bonus: 'sluice', x: 56, y: 37 },
        { id: 'palate', name: 'The Palate', bonus: 'trove', x: 70, y: 16 },
        { id: 'sinus', name: 'The Sinus', bonus: 'richseam', x: 83, y: 16 },
        { id: 'throat', name: 'The Throat', bonus: 'schooling', x: 90, y: 27 },
        { id: 'nursery', name: 'The Nursery', bonus: 'coinfall', x: 30, y: 15 },
        { id: 'brood', name: 'The Brood Chamber', bonus: 'trove', x: 47, y: 15 },
        { id: 'farthroat', name: 'The Far Throat', bonus: 'coinfall', x: 7, y: 31 },
        { id: 'marrow', name: 'The Marrow', bonus: 'sluice', x: 15, y: 49 },
        { id: 'gland', name: 'The Gland', bonus: 'trove', x: 26, y: 48 },
        { id: 'bowel', name: 'The Bowel', bonus: 'richseam', x: 14, y: 69 },
        { id: 'sac', name: 'The Sac', bonus: 'schooling', x: 25, y: 76 },
      ...
      links: [
        ...
        { from: 'nursery', to: 'brood' },
        { from: 'd12', to: 'lung', path: [[69,69],[72,65],[82,64]] },
        { from: 'lung', to: 'crop' },
        { from: 'lung', to: 'ribs' },
        { from: 'ribs', to: 'sinus' },
        { from: 'sinus', to: 'palate' },
        { from: 'sinus', to: 'throat', path: [[83,16],[90,16],[90,27]] },
        { from: 'palate', to: 'blister' },
        { from: 'palate', to: 'gorge' },
        { from: 'gorge', to: 'craw' },
        { from: 'throat', to: 'farthroat', portal: [[93,27],[4,31]] },
        { from: 'farthroat', to: 'weeping' },
        { from: 'weeping', to: 'marrow' },
        { from: 'marrow', to: 'gland' },
        { from: 'marrow', to: 'bowel' },
        { from: 'bowel', to: 'sac' },
        { from: 'sac', to: 'meatfold' },
        { from: 'meatfold', to: 'heartrot' },
        { from: 'sac', to: 'cyst', path: [[25,76],[22,81],[13,92],[8,92]] },
        { from: 'd13', to: 'drain' },
        { from: 'drain', to: 'offal' },
      ],
...
export const SKILLS: SkillDef[] = [
  ...
  },
  {
    ...
    category: 'spell',
    description:
      'Ice drives up from the ground, hitting every enemy in a 1.3 tile radius.',
    tags: ['spell', 'area'],
    behaviour: 'spike',
    damageTypes: ['cold'],
