  ...
  zones: [
    {
      ...
      path: [[15, 19], [22, 29], [28, 28], [33, 37], [38, 38], [46, 51], [53, 51],
        [63, 68], [70, 68], [77, 81], [82, 81], [90, 96], [92, 95]],
      sides: [
        { id: 'spoil', name: 'The Spoil Heap', bonus: 'coinfall', x: 40, y: 12 },
        { id: 'crosscut', name: 'The Crosscut', bonus: 'sluice', x: 53, y: 21 },
        { id: 'breast', name: 'The Breast', bonus: 'trove', x: 59, y: 21 },
        { id: 'stope', name: 'The Old Stope', bonus: 'richseam', x: 44, y: 30 },
        { id: 'winze', name: 'The Winze', bonus: 'schooling', x: 54, y: 30 },
        { id: 'heading', name: 'The Heading', bonus: 'swarm', x: 62, y: 10 },
        { id: 'drift', name: 'The Drift', bonus: 'coinfall', x: 63, y: 26 },
        { id: 'gallery', name: 'The Upper Gallery', bonus: 'sluice', x: 74, y: 26 },
        { id: 'rise', name: 'The Rise', bonus: 'trove', x: 78, y: 8 },
        { id: 'chimney', name: 'The Chimney', bonus: 'richseam', x: 87, y: 9 },
        { id: 'bench', name: 'The Bench', bonus: 'schooling', x: 87, y: 26 },
        { id: 'stull', name: 'The Stull', bonus: 'swarm', x: 72, y: 38 },
        { id: 'plat', name: 'The Plat', bonus: 'coinfall', x: 79, y: 39 },
        { id: 'slope', name: 'The Slope', bonus: 'sluice', x: 70, y: 40 },
        { id: 'shaftfoot', name: 'The Shaft Foot', bonus: 'trove', x: 71, y: 48 },
        { id: 'adit', name: 'The Adit', bonus: 'richseam', x: 78, y: 61 },
        { id: 'faradit', name: 'The Far Adit', bonus: 'schooling', x: 91, y: 61 },
        { id: 'oldworks', name: 'The Old Workings', bonus: 'swarm', x: 15, y: 40 },
        { id: 'level', name: 'The Long Level', bonus: 'coinfall', x: 19, y: 51 },
        { id: 'crosslevel', name: 'The Cross Level', bonus: 'sluice', x: 28, y: 51 },
        { id: 'sump', name: 'The Sump', bonus: 'trove', x: 30, y: 66 },
        { id: 'gullet', name: 'The Gullet', bonus: 'richseam', x: 43, y: 66 },
        { id: 'deeplevel', name: 'The Deep Level', bonus: 'schooling', x: 21, y: 72 },
        ...
        { id: 'lastlevel', name: 'The Last Level', bonus: 'trove', x: 43, y: 88 },
      ],
      links: [
        { from: 'stull', to: 'slope', path: [[72,38],[72,40],[70,40]] },
        { from: 'crosscut', to: 'breast', path: [[53,21],[53,22],[59,22],[59,21]] },
        { from: 'stope', to: 'winze', path: [[44,31],[54,31]] },
        { from: 'deadend', to: 'lastlevel', path: [[44,78],[43,88]] },
        { from: 'gullet', to: 'deadend', path: [[43,66],[43,78],[44,78]] },
        { from: 'd4', to: 'stope', path: [[37,38],[40,38],[40,33],[42,33],[42,31],[44,31]] },
        { from: 'rise', to: 'chimney', path: [[78,8],[78,12],[87,12],[87,9]] },
        { from: 'gallery', to: 'bench', path: [[74,26],[83,26],[83,27],[87,27],[87,26]] },
        { from: 'bottom', to: 'footwall', path: [[10,87],[10,89],[21,89],[21,87]] },
        { from: 'drift', to: 'gallery', path: [[63,26],[63,28],[72,28],[72,26],[74,26]] },
        { from: 'adit', to: 'faradit', path: [[78,61],[78,62],[91,62],[91,61]] },
        { from: 'sump', to: 'gullet', path: [[30,66],[30,67],[43,67],[43,66]] },
        { from: 'level', to: 'crosslevel', path: [[19,51],[19,54],[28,54],[28,51]] },
        { from: 'deeplevel', to: 'footwall', path: [[21,72],[21,87]] },
        { from: 'crosslevel', to: 'sump', path: [[28,51],[29,66],[30,66]] },
        { from: 'sump', to: 'deeplevel', path: [[30,66],[26,66],[26,71],[25,71],[25,72],[23,72],[23,74],[21,74],[21,72]] },
        { from: 'd2', to: 'oldworks', path: [[21,28],[22,28],[22,34],[20,34],[20,36],[19,36],[19,38],[18,38],[18,40],[15,40]] },
        { from: 'bench', to: 'plat', path: [[87,26],[87,27],[83,27],[83,32],[81,32],[81,39],[79,39]] },
        { from: 'crosscut', to: 'stope', path: [[53,21],[53,22],[49,22],[49,21],[44,21],[44,31]] },
        { from: 'heading', to: 'drift', path: [[62,11],[62,28],[63,28],[63,26]] },
        { from: 'd5', to: 'stope', path: [[43,47],[43,46],[40,46],[40,33],[42,33],[42,31],[44,31]] },
        { from: 'plat', to: 'shaftfoot', path: [[79,39],[78,39],[78,52],[71,52],[71,48]] },
        { from: 'd3', to: 'oldworks', path: [[30,32],[30,31],[22,31],[22,34],[20,34],[20,36],[19,36],[19,38],[18,38],[18,40],[15,40]] },
        { from: 'footwall', to: 'lastlevel', path: [[21,87],[21,89],[43,89],[43,88]] },
        { from: 'gallery', to: 'plat', path: [[74,26],[83,26],[83,32],[81,32],[81,39],[79,39]] },
        { from: 'd4', to: 'crosslevel', path: [[37,38],[34,38],[34,45],[33,45],[33,47],[32,47],[32,48],[31,48],[31,53],[28,53],[28,51]] },
        { from: 'level', to: 'sump', path: [[19,51],[19,54],[29,54],[29,66],[30,66]] },
        { from: 'd9', to: 'adit', path: [[73,73],[73,74],[78,74],[78,69],[80,69],[80,67],[81,67],[82,62],[78,62],[78,61]] },
        { from: 'oldworks', to: 'level', path: [[15,40],[15,41],[12,41],[12,54],[19,54],[19,51]] },
        { from: 'd6', to: 'slope', path: [[53,51],[56,51],[56,46],[57,46],[57,43],[59,43],[59,40],[70,40]] },
        { from: 'd10', to: 'adit', path: [[79,81],[78,81],[78,69],[80,69],[80,67],[81,67],[82,62],[78,62],[78,61]] },
        { from: 'spoil', to: 'crosscut', path: [[40,12],[40,12],[40,22],[41,22],[41,21],[50,21],[50,22],[53,22],[53,21]] },
        { from: 'd3', to: 'spoil', path: [[30,32],[29,32],[30,21],[31,21],[32,18],[33,18],[33,16],[34,16],[34,14],[35,14],[35,13],[40,13],[40,12]] },
      ],
