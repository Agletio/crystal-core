  ...
  zones: [
    {
      ...
      links: [
        ...
        { from: 'crosscut', to: 'breast', path: [[53,21],[59,21]] },
        { from: 'stull', to: 'plat', path: [[72,38],[79,39]] },
        { from: 'stope', to: 'winze', path: [[44,31],[54,31]] },
        { from: 'deadend', to: 'lastlevel', path: [[44,78],[43,88]] },
        { from: 'gullet', to: 'deadend', path: [[43,66],[44,78]] },
        { from: 'd4', to: 'stope', path: [[37,38],[40,38],[40,33],[44,31]] },
        { from: 'rise', to: 'chimney', path: [[78,8],[78,12],[87,12],[87,9]] },
        { from: 'gallery', to: 'bench', path: [[74,26],[87,26]] },
        { from: 'bottom', to: 'footwall', path: [[10,87],[10,89],[21,89],[21,87]] },
        { from: 'drift', to: 'gallery', path: [[63,26],[63,28],[72,28],[72,26],[74,26]] },
        { from: 'adit', to: 'faradit', path: [[78,61],[91,61]] },
        { from: 'sump', to: 'gullet', path: [[30,66],[43,66]] },
        { from: 'level', to: 'crosslevel', path: [[19,51],[19,54],[28,54],[28,51]] },
        { from: 'deeplevel', to: 'footwall', path: [[21,72],[21,87]] },
        { from: 'crosslevel', to: 'sump', path: [[28,51],[30,66]] },
        { from: 'sump', to: 'deeplevel', path: [[30,66],[26,66],[23,74],[21,74],[21,72]] },
        { from: 'd2', to: 'oldworks', path: [[21,28],[22,34],[20,34],[18,40],[15,40]] },
        { from: 'bench', to: 'plat', path: [[87,26],[83,27],[81,39],[79,39]] },
        { from: 'crosscut', to: 'stope', path: [[53,21],[44,21],[44,31]] },
        { from: 'heading', to: 'drift', path: [[62,11],[62,28],[63,26]] },
        { from: 'plat', to: 'shaftfoot', path: [[79,39],[78,52],[71,52],[71,48]] },
        { from: 'footwall', to: 'lastlevel', path: [[21,87],[21,89],[43,88]] },
        { from: 'd4', to: 'crosslevel', path: [[37,38],[34,38],[34,45],[31,48],[31,53],[28,53],[28,51]] },
        { from: 'd9', to: 'adit', path: [[73,73],[78,74],[78,69],[81,67],[82,62],[78,61]] },
        { from: 'oldworks', to: 'level', path: [[15,40],[12,41],[12,54],[19,54],[19,51]] },
        { from: 'd6', to: 'slope', path: [[53,51],[56,51],[59,40],[70,40]] },
        { from: 'spoil', to: 'crosscut', path: [[40,12],[40,22],[53,21]] },
        { from: 'd3', to: 'spoil', path: [[30,32],[30,21],[34,14],[40,12]] },
        { from: 'chimney', to: 'bench', path: [[87,9],[87,13],[96,13],[96,17],[100,17],[100,22],[94,22],[94,26],[91,27],[87,26]] },
      ],
