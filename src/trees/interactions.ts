...
export const INTERACTIONS: Interaction[] = [
  ...
  { pair: ['scale', 'crit'], says: 'A crit turned into an ailment carries the scaling into the ailment.' },
  ...
  { pair: ['duration', 'crit'], says: 'The ailment a crit leaves instead runs the longer duration.' },
  ...
  { pair: ['targets', 'crit'], says: 'Crit is rolled once for the whole cast, so a critical use crits every target it touches.' },
  ...
  { pair: ['burst', 'crit'], says: 'A crit that becomes an ailment still bursts — the burst is the hit that carried it.' },
  ...
  { pair: ['field', 'crit'], says: 'A critical tick plants a fresh cloud, which is a circle of its own and can plant again.' },
  { pair: ['field', 'type'], says: 'The cloud deals the converted type, and so does anything it plants.' },

  { pair: ['crit', 'crit'], says: 'Both read one roll: the hit is suppressed once, and what rides the tick still rides it.' },
