...
const MATCH: [RegExp, string][] = [
  ...
  [/monster|pack ?(count|size)/i, 'skull'],
  [/fire|burn|ember|cinder|ignit|scorch/i, 'flame'],
  [/cold|frost|chill|freez|rime/i, 'frost'],
  [/lightning|arc\b|shock|storm/i, 'bolt'],
  [/poison|blight|toxi|venom|bleed|ailment/i, 'skull'],
  [/crit/i, 'star'],
  [/mana|thrift|clarity/i, 'droplet'],
  [/life|vital/i, 'heart'],
  [/projectile|arrow|volley|salvo|pierce/i, 'arrow'],
  [/area|radius|splash|cloud|burst|nova|spread/i, 'burst'],
  [/speed|haste|swift|quick/i, 'wing'],
  [/armou?r|shield|ward|resist|defen/i, 'shield'],
  [/duration|linger|lasting/i, 'hourglass'],
  [/spell/i, 'orb'],
  [/attack|damage|strike|blade|sword|force/i, 'sword'],
];
...
const GROUPS: [RegExp, string][] = [
  [/critMultiplier/i, 'skull'],
  [/critChance/i, 'star'],
  [/damage:(cold|chill)|freeze|chill/i, 'frost'],
  [/damage:(fire|burn)|burn/i, 'flame'],
  [/damage:(lightning|shock)|shock/i, 'bolt'],
  [/bleed/i, 'g_bleed'],
  [/damage:poison|poison/i, 'droplet'],
  [/ailment/i, 'g_ailment'],
  [/damage:physical/i, 'g_physical'],
  [/\bdamage\b/i, 'g_damage'],
  [/castSpeed|attackSpeed|gustSpeed/i, 'wing'],
  [/areaOfEffect|cone/i, 'burst'],
  [/attackRange|moveDistance/i, 'arrow'],
  [/mana/i, 'orb'],
  [/moveSpeed/i, 'g_move'],
  [/cooldown/i, 'hourglass'],
  [/tempo/i, 'g_stack'],
  [/guard/i, 'shield'],
];
