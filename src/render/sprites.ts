...
export const MONSTER_FRAMES: Record<string, string[][]> = {
  ...
  // Thin and hunched, leaning the way it walks. A person, badly.
  husk: [
    [
      '................',
      '................',
  ...
  // A slab with shoulders. Wider than it is tall in the chest, which is the
  // only thing that has to read at three pixels.
  brute: [
    [
      '................',
      '................',
